...
class PromptManager:
    ...
    def __init__(self,
                 ...
                 placeholder_style_token_ids: List[int] = None,
    ...
    def embed_prompt(self,
        ...
        input_ids_placeholder_style = get_input_ids_placeholder(ids, self.placeholder_style_token_ids)
        ...
        for timestep in tqdm(self.timesteps):
            ...
            for layer_idx, unet_layer in enumerate(self.unet_layers):
                batch = NeTIBatch(
                    ...
                    input_ids_placeholder_style=input_ids_placeholder_style.to(device),
